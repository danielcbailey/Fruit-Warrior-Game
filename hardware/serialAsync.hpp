...
class SerialAsync {
    ...
    /**
     * Waits for any outstanding transmissions to complete
     */
    void sync();
    ...
    /**
     * If there is a possibility of a write command being sent from an ISR,
     * then this must be set to disable free being called from an ISR, which
     * would lead to heap corruption.
     */
    inline void setISRPossibility(bool value) { this->isrPossibility = value; }
